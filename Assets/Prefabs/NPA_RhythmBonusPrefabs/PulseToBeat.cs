    ...
    public class PulseToBeat : MonoBehaviour
    {
        ...
        IEnumerator PulseRoutine()
        {
            ...
            while (true)
            {
                ...
                // This line below locks Unity and must be forced closed. Why?
                // It is important in order to recalculate all variables properly, though.
                //nextBeat = music.SongStartDSP + pulseOffsetSec + beatSec;
            }
        }
    }
}