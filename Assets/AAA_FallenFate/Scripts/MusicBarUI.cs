    ...
    public class MusicBarUI : MonoBehaviour
    {
        ...
        */
        ...
        private void AddNewMarker(Vector3 position)
        {
            ...
            if (m_BeatMarkerPrefab == null)
            {
                Debug.LogError("MusicBarUI: m_BeatMarkerPrefab is not assigned! Cannot create beat markers.");
                return;
            }
        ...
        private void handleBeatOnCenter()
        {
            ...
            {
                Debug.LogWarning("MusicBarUI.handleBeatOnCenter: Beat markers are not available, skipping beat handling.");
                return;
            }
        ...
        {
            if (m_BeatMarkersList == null || m_BeatMarkersList.Count == 0)
            {
                Debug.LogError("MusicBarUI: Beat markers list is empty or null!");
                return null;
            }
