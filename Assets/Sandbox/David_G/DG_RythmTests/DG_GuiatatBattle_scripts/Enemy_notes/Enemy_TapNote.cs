...
namespace Dypsloom.RhythmTimeline.Core.Notes
{
    ...
    /// </summary>
    public class Enemy_TapNote : Note       
    {
        ...
        protected override void HybridUpdate(double timeFromStart, double timeFromEnd)
        {
            ...
            // Auto-trigger a perfect tap once this note reaches its timing window.
            if (Application.isPlaying && m_AutoPlay && !m_IsTriggered && timeFromStart >= perfectTime) {
