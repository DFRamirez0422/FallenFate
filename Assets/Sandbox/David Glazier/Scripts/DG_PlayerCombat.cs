...
{
    public class DG_PlayerCombat : MonoBehaviour
    {
        [Header("References")]
        ...
        [SerializeField] private DG_RythmCombat rhythmCombat;
        ...
        {
            int currentCombo = rhythmCombat.perfectHits;
        ...
        private void Attack(AttackData attackData)
        {
            ...
            // Rhythm combat tracking with DG_RythmCombat
            if (rhythmCombat != null)
            {
                Debug.Log($"[Rhythm] Perfect Hits: {rhythmCombat.perfectHits}");
            }
        ...
        private void UpdateDebugUi()
        {
            ...
            int current_combo = rhythmCombat != null ? rhythmCombat.perfectHits : 0;
