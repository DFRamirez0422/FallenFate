...
public class PotionThrowOnBeat : MonoBehaviour
{
    [Header("References")]
    ...
    public int beatCount = 0; // Counts the number of beats detected to throw the potion
    public int throwIntervalOnBeat = 3; // Number of beats to wait before throwing the potion
    ...
    {
        if (beatCount >= throwIntervalOnBeat && IsPlayerInRange())
        {
            ThrowPotionAtPlayer();
            beatCount = 0;
        }
