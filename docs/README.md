...
| [2026-04-14 -- PickUp Manager Key Inventory Reset](2026-04-14_pickup-manager-key-inventory-reset.md) | Clear key items on main menu, same-scene reload, or after game-over so keys are not stuck across replay |
